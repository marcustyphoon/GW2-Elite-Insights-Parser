...
namespace GW2EIEvtcParser.EIData
{
    public class Buff : IVersionable
    {
        ...
        internal static readonly List<Buff> AscendedFood = new List<Buff>
        {
                ...
                new Buff("Spherified Cilantro Oyster Soup", SpherifiedCilantroOysterSoup, Source.Item, BuffClassification.Consumable, "https://wiki.guildwars2.com/images/e/e1/Spherified_Cilantro_Oyster_Soup.png"),
